...
CREATE TABLE `integrante` (
  ...
  `instituto` VARCHAR(45) NULL DEFAULT NULL,
  `categoriaDocente` VARCHAR(45) NULL DEFAULT NULL,
  `dedicacion` VARCHAR(45) NULL DEFAULT NULL,
  `categoriaExtensionista` VARCHAR(100) NULL DEFAULT NULL,
  `direccion` VARCHAR(150) NOT NULL,
  `direccion_CodPostal` VARCHAR(45) NOT NULL,
  `telefono` VARCHAR(45) NOT NULL,
  `afeccionHorasSemanal` VARCHAR(3) NOT NULL,
  `rol` VARCHAR(45) NOT NULL,
  `email` VARCHAR(45) NOT NULL,
  `organizacion` VARCHAR(45) NULL DEFAULT NULL,
  `funcion` VARCHAR(100) NULL DEFAULT NULL,
  `nivelEstudios` VARCHAR(45) NULL DEFAULT NULL,
  `ocupacion` VARCHAR(100) NULL DEFAULT NULL,
  `afeccionTotalHoral` VARCHAR(6) NOT NULL,
  `tipo_id` INT(11) NULL,
  `carrera_Cod` INT(3) UNSIGNED ZEROFILL NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_integrante_direccion1`
    FOREIGN KEY (`direccion_CodPostal`)
    REFERENCES `bdkiush`.`direccion` (`CodPostal`),
  CONSTRAINT `fk_integrante_tipo1`
    FOREIGN KEY (`tipo_id`)
    REFERENCES `bdkiush`.`tipo` (`id`),
  CONSTRAINT `fk_integrante_carrera1`
    FOREIGN KEY (`carrera_Cod`)
    REFERENCES `bdkiush`.`carrera` (`Cod`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tipo` VALUES (1,'alumno'),(2,'docente'),(3,'no docente'),(4,'externo');
...
-- Dump completed on 2023-10-20 18:20:59
